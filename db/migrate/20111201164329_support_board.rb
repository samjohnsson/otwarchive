class SupportBoard < ActiveRecord::Migration

# TODO add names to watchers so can send email with names (looks less like spam)
  ...
  def self.up
    ...
    add_index :support_watchers, :support_ticket_id
    add_index :support_watchers, :public_watcher
    add_index :support_watchers, :email
    add_index :support_watchers, :official
    ...
    create_table :faq_watchers do |t|
      t.integer :faq_id
      t.string :email
      t.boolean :official, :default => false
    ...
    add_index :faq_watchers, :faq_id
    add_index :faq_watchers, :email
    add_index :faq_watchers, :official
    ...
    add_index :code_watchers, :code_ticket_id
    add_index :code_watchers, :email
    add_index :code_watchers, :official
