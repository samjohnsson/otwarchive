# demo support board seed data.
#  load by running
#  rails runner db/support_demo_seeds.rb

# get around attribute protected errors
class User
  def self.do_create!(login, email)
...
# users
newbie = User.do_create!("newbie", "newbie@ao3.org")

dean = User.do_create!("dean", "dean@ao3.org")
john = User.do_create!("john", "john@ao3.org")
jim = User.do_create!("jim", "jim@ao3.org")

# support volunteers
sam = User.do_create!("sam", "sam@ao3.org")
sam.support_staffer = "1"
blair = User.do_create!("blair", "blair@ao3.org")
blair.support_staffer = "1"

# support admin
rodney = User.do_create!("rodney", "rodney@ao3.org")
rodney.support_staffer = "1"
rodney.support_admin = "1"
sidra = User.do_create!("sidra", "sidra@ao3.org")
