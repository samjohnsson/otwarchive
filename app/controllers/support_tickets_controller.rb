class SupportTicketsController < ApplicationController
  ...
  def show
    ...
    if @ticket.private && (!is_owner && !current_user.try(:support_staffer?))
      flash[:error] = "Sorry, you don't have permission to view this ticket"
      redirect_to support_board_path and return
    end
    ...
    if is_owner && !params[:support]
      ...
      render :show_guest
    elsif current_user.support_staffer?
      @add_details = true # create a new empty response template
